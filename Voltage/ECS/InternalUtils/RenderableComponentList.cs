...
public class RenderableComponentList
{
	...
	/// </summary>
	private FastList<IRenderable> _components = new();

	/// <summary>
	/// tracks components by renderLayer for easy retrieval
	/// </summary>
	private Dictionary<int, FastList<IRenderable>> _componentsByRenderLayer = new();

	private List<int> _unsortedRenderLayers = new();
	private bool _componentsNeedSort = true;

	public FastList<IRenderable> Components => _components;
