...
sampler2D _normalMapSampler = sampler_state // Excplicitly set the SampleState to Point.Clamp
{
    Texture = <_normalMap>;
    MinFilter = Point;
    MagFilter = Point;
...
sampler2D _colorMapSampler = sampler_state
{
    Texture = <_colorMap>;
    MinFilter = Point;
    MagFilter = Point;
...
sampler _lightMapSampler = sampler_state
{
    Texture = <_lightMap>;
    MinFilter = Point;
    MagFilter = Point;
