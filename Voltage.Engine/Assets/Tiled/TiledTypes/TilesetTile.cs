...
namespace Voltage.Tiled
{
	public class TmxTilesetTile
	{
		...
		/// <summary>
		/// returns the value of an "voltage:isDestructable" property if present in the properties dictionary
		/// </summary>
		/// <value><c>true</c> if is destructable; otherwise, <c>false</c>.</value>
		public bool IsDestructable;

		/// <summary>
		/// returns the value of a "voltage:isSlope" property if present in the properties dictionary
		/// </summary>
		/// <value>The is slope.</value>
		public bool IsSlope;

		/// <summary>
		/// returns the value of a "voltage:isOneWayPlatform" property if present in the properties dictionary
		/// </summary>
		public bool IsOneWayPlatform;

		/// <summary>
		/// returns the value of a "voltage:slopeTopLeft" property if present in the properties dictionary
		/// </summary>
		/// <value>The slope top left.</value>
		public int SlopeTopLeft;

		/// <summary>
		/// returns the value of a "voltage:slopeTopRight" property if present in the properties dictionary
		/// </summary>
		...
		{
			string value;
			if (Properties.TryGetValue("voltage:isDestructable", out value))
				IsDestructable = bool.Parse(value);

			if (Properties.TryGetValue("voltage:isSlope", out value))
				IsSlope = bool.Parse(value);

			if (Properties.TryGetValue("voltage:isOneWayPlatform", out value))
				IsOneWayPlatform = bool.Parse(value);

			if (Properties.TryGetValue("voltage:slopeTopLeft", out value))
				SlopeTopLeft = int.Parse(value);

			if (Properties.TryGetValue("voltage:slopeTopRight", out value))
